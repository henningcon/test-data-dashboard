...
if ("PS1" or "PS2" or "PS3") in measurements:
    ...
    y1_axis = alt.Chart(melted).mark_line().encode(
        ...
        color = alt.Color("Pressure", legend=alt.Legend(orient="bottom"), title="")
    )
    axes.append(y1_axis)
...
if "Position" in measurements:
    ...
    y2_axis = alt.Chart(position_df).mark_line().encode(
        ...
        color = alt.Color("Position", legend=alt.Legend(orient="bottom"), title="")
    )
    axes.append(y2_axis)
...
if "Flow" in measurements:
    ...
    y3_axis = alt.Chart(flow_df).mark_line(color="purple").encode(
        ...
        color = alt.Color("Flow", legend=alt.Legend(orient="bottom"), title="")
    )
    axes.append(y3_axis)
